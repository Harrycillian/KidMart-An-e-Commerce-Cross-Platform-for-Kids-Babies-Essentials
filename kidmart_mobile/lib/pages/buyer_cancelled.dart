...
class _CancelledOrdersState extends State<CancelledOrders> {
  ...
  // for fetching orders that are Cancelled
    ...
    while (retryCount < _maxRetries) {
      try {
        final response = await _client.get(
          Uri.parse('${ApiConstants.baseUrl}/mview-cancelled-orders/${widget.userId}'),
          headers: {
  ...
  // function for when changing tabs
  ...
  // population of items each order
  ...
  // buttons change depending on status selected
