...
class ToApproveOrders extends StatefulWidget {
  final int userId;

  const ToApproveOrders({
    Key? key, 
    required this.userId,
  }) : super(key: key);

  @override
  State<ToApproveOrders> createState() => _ToApproveOrdersState();
}

class _ToApproveOrdersState extends State<ToApproveOrders> {
    ...
    while (retryCount < _maxRetries && mounted) {
      try {
        final response = await _client.get(
          Uri.parse('${ApiConstants.baseUrl}/mview-to-approve-orders/${widget.userId}'),
          headers: {
